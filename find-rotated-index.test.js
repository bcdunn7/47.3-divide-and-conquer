...
describe("#findRotatedIndex", function(){
  it("returns the correct index", function(){
    ...
    expect(findRotatedIndex([9, 1, 2, 3, 4, 5, 6, 7, 8], 2)).toBe(2)
    expect(findRotatedIndex([9, 1, 2, 3, 4, 5, 6, 7, 8], 9)).toBe(0)
    expect(findRotatedIndex([9, 1, 2, 3, 4, 5, 6, 7, 8], 8)).toBe(8)
  })
})